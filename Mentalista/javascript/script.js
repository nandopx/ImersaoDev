...
function jogar() {
    document.getElementById('escolha').innerHTML = "<h2 class='nome'>Informe primeiro nome</h2><input type='text' class='input-nome' id='input-nome'><input type='button' class='btn-iniciar' id='iniciar' onclick='iniciar()' value='Iniciar'>"
}
